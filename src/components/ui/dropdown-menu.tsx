...
>(({ className, sideOffset = 6, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        "z-[9999] min-w-[13rem] overflow-hidden rounded-xl border border-white/15 bg-[#18181c] p-1.5 text-popover-foreground shadow-2xl shadow-black/80 ring-1 ring-white/10",
