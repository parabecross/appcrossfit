...
CREATE TABLE IF NOT EXISTS ranking_config (
  ...
  position_points_table       JSONB NOT NULL DEFAULT '[30,28,26,24,22,20,19,18,17,16]'::jsonb,
  position_points_floor       INTEGER NOT NULL DEFAULT 5 CHECK (position_points_floor >= 0),
  position_points_linear_drop INTEGER NOT NULL DEFAULT 1 CHECK (position_points_linear_drop >= 0),
